...
C:/VulkanSDK/1.1.130.0/Bin32/glslc.exe -fshader-stage=frag particleFragment.glsl -o particleFragment.spv
C:/VulkanSDK/1.1.130.0/Bin32/glslc.exe -fshader-stage=vertex particleVertex.glsl -o particleVertex.spv
